...
{
    /// <inheritdoc />
    public partial class renameandaddmass : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "Comments", "DateEnd", "DateStart", "Mass" },
                values: new object[,]
                {
                    { 1, "My first exercise!", new DateTime(2025, 2, 2, 12, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 1, 1, 12, 0, 0, 0, DateTimeKind.Unspecified), 5.0 },
                    { 2, "My second exercise 8)", new DateTime(2025, 1, 1, 14, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 1, 1, 12, 0, 0, 0, DateTimeKind.Unspecified), 10.0 },
                    { 3, "", new DateTime(2026, 1, 1, 17, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2026, 1, 1, 16, 30, 0, 0, DateTimeKind.Unspecified), 11.0 },
                    { 4, "", new DateTime(2025, 11, 10, 0, 0, 50, 0, DateTimeKind.Unspecified), new DateTime(2025, 11, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), 15.0 },
                    { 5, "My final exercise!", new DateTime(2026, 12, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 12, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), 20.0 }
                });
        }
